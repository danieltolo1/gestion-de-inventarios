...
const relationResolversInfo = {
    Product: ["product_type", "state", "location", "maintenance"],
    Product_Type: ["product"],
    State: ["product", "computer"],
    Computer: ["state", "softwarecomputer", "location", "maintenance", "program"],
    SoftwareComputer: ["computer"],
    Program: ["computer"],
    Location: ["computer", "porduct"],
    Maintenance: ["user", "computer", "product"],
    Account: ["user"],
    Session: ["user"],
...
const modelsInfo = {
    Product: ["id_product", "internal_code", "serial_number", "imei", "observation", "picture", "model", "product_typeId", "size", "tecnology", "conectivity", "stateId", "locationId", "historial"],
    Product_Type: ["id_product_type", "description"],
    State: ["id_state", "description"],
    Computer: ["id_computer", "buy_date", "price", "internal_code", "serial_number", "memory", "hard_disk", "processor", "optical_unit", "model", "stateId", "ip", "softwarecomputerId", "locationId", "observation", "historial", "user_domain", "pass_domain", "user_admin", "pass_admin", "user_local", "pass_local", "user_anydesk", "pass_anydesk"],
    SoftwareComputer: ["id_softwarecomputer", "operatingsystem", "license_soA", "architecture"],
    Program: ["id_program", "name_program", "version_program", "license_program"],
    Location: ["id_location", "internal_code", "city", "job_name"],
    Maintenance: ["id_maintenance", "date_maintenance", "jworkerNameFirm", "userId", "computerId", "observation"],
...
const outputsInfo = {
    ...
    ProductGroupBy: ["id_product", "internal_code", "serial_number", "imei", "observation", "picture", "model", "product_typeId", "size", "tecnology", "conectivity", "stateId", "locationId", "historial", "_count", "_avg", "_sum", "_min", "_max"],
    ...
    ComputerGroupBy: ["id_computer", "buy_date", "price", "internal_code", "serial_number", "memory", "hard_disk", "processor", "optical_unit", "model", "stateId", "ip", "softwarecomputerId", "locationId", "observation", "historial", "user_domain", "pass_domain", "user_admin", "pass_admin", "user_local", "pass_local", "user_anydesk", "pass_anydesk", "_count", "_avg", "_sum", "_min", "_max"],
    AggregateSoftwareComputer: ["_count", "_avg", "_sum", "_min", "_max"],
    SoftwareComputerGroupBy: ["id_softwarecomputer", "operatingsystem", "license_soA", "architecture", "_count", "_avg", "_sum", "_min", "_max"],
    AggregateProgram: ["_count", "_avg", "_sum", "_min", "_max"],
    ProgramGroupBy: ["id_program", "name_program", "version_program", "license_program", "_count", "_avg", "_sum", "_min", "_max"],
    AggregateLocation: ["_count", "_avg", "_sum", "_min", "_max"],
    LocationGroupBy: ["id_location", "internal_code", "city", "job_name", "_count", "_avg", "_sum", "_min", "_max"],
    AggregateMaintenance: ["_count", "_avg", "_sum", "_min", "_max"],
    MaintenanceGroupBy: ["id_maintenance", "date_maintenance", "jworkerNameFirm", "userId", "computerId", "observation", "_count", "_avg", "_sum", "_min", "_max"],
    ...
    ProductCount: ["maintenance"],
    ProductCountAggregate: ["id_product", "internal_code", "serial_number", "imei", "observation", "picture", "model", "product_typeId", "size", "tecnology", "conectivity", "stateId", "locationId", "historial", "_all"],
    ProductAvgAggregate: ["id_product", "product_typeId", "stateId", "locationId"],
    ProductSumAggregate: ["id_product", "product_typeId", "stateId", "locationId"],
    ProductMinAggregate: ["id_product", "internal_code", "serial_number", "imei", "observation", "picture", "model", "product_typeId", "size", "tecnology", "conectivity", "stateId", "locationId", "historial"],
    ProductMaxAggregate: ["id_product", "internal_code", "serial_number", "imei", "observation", "picture", "model", "product_typeId", "size", "tecnology", "conectivity", "stateId", "locationId", "historial"],
    ...
    ComputerCount: ["maintenance", "program"],
    ComputerCountAggregate: ["id_computer", "buy_date", "price", "internal_code", "serial_number", "memory", "hard_disk", "processor", "optical_unit", "model", "stateId", "ip", "softwarecomputerId", "locationId", "observation", "historial", "user_domain", "pass_domain", "user_admin", "pass_admin", "user_local", "pass_local", "user_anydesk", "pass_anydesk", "_all"],
    ComputerAvgAggregate: ["id_computer", "price", "stateId", "softwarecomputerId", "locationId"],
    ComputerSumAggregate: ["id_computer", "price", "stateId", "softwarecomputerId", "locationId"],
    ComputerMinAggregate: ["id_computer", "buy_date", "price", "internal_code", "serial_number", "memory", "hard_disk", "processor", "optical_unit", "model", "stateId", "ip", "softwarecomputerId", "locationId", "observation", "historial", "user_domain", "pass_domain", "user_admin", "pass_admin", "user_local", "pass_local", "user_anydesk", "pass_anydesk"],
    ComputerMaxAggregate: ["id_computer", "buy_date", "price", "internal_code", "serial_number", "memory", "hard_disk", "processor", "optical_unit", "model", "stateId", "ip", "softwarecomputerId", "locationId", "observation", "historial", "user_domain", "pass_domain", "user_admin", "pass_admin", "user_local", "pass_local", "user_anydesk", "pass_anydesk"],
    SoftwareComputerCount: ["computer"],
    SoftwareComputerCountAggregate: ["id_softwarecomputer", "operatingsystem", "license_soA", "architecture", "_all"],
    SoftwareComputerAvgAggregate: ["id_softwarecomputer"],
    SoftwareComputerSumAggregate: ["id_softwarecomputer"],
    SoftwareComputerMinAggregate: ["id_softwarecomputer", "operatingsystem", "license_soA", "architecture"],
    SoftwareComputerMaxAggregate: ["id_softwarecomputer", "operatingsystem", "license_soA", "architecture"],
    ProgramCount: ["computer"],
    ProgramCountAggregate: ["id_program", "name_program", "version_program", "license_program", "_all"],
    ProgramAvgAggregate: ["id_program"],
    ProgramSumAggregate: ["id_program"],
    ProgramMinAggregate: ["id_program", "name_program", "version_program", "license_program"],
    ProgramMaxAggregate: ["id_program", "name_program", "version_program", "license_program"],
    LocationCount: ["computer", "porduct"],
    LocationCountAggregate: ["id_location", "internal_code", "city", "job_name", "_all"],
    LocationAvgAggregate: ["id_location", "internal_code"],
    LocationSumAggregate: ["id_location", "internal_code"],
    LocationMinAggregate: ["id_location", "internal_code", "city", "job_name"],
    LocationMaxAggregate: ["id_location", "internal_code", "city", "job_name"],
    MaintenanceCount: ["product"],
    MaintenanceCountAggregate: ["id_maintenance", "date_maintenance", "jworkerNameFirm", "userId", "computerId", "observation", "_all"],
    MaintenanceAvgAggregate: ["id_maintenance", "computerId"],
    MaintenanceSumAggregate: ["id_maintenance", "computerId"],
    MaintenanceMinAggregate: ["id_maintenance", "date_maintenance", "jworkerNameFirm", "userId", "computerId", "observation"],
    MaintenanceMaxAggregate: ["id_maintenance", "date_maintenance", "jworkerNameFirm", "userId", "computerId", "observation"],
...
const inputsInfo = {
    ProductWhereInput: ["AND", "OR", "NOT", "id_product", "internal_code", "serial_number", "imei", "observation", "picture", "model", "product_type", "product_typeId", "size", "tecnology", "conectivity", "state", "stateId", "location", "locationId", "historial", "maintenance"],
    ProductOrderByWithRelationInput: ["id_product", "internal_code", "serial_number", "imei", "observation", "picture", "model", "product_type", "product_typeId", "size", "tecnology", "conectivity", "state", "stateId", "location", "locationId", "historial", "maintenance"],
    ProductWhereUniqueInput: ["id_product", "internal_code"],
    ProductOrderByWithAggregationInput: ["id_product", "internal_code", "serial_number", "imei", "observation", "picture", "model", "product_typeId", "size", "tecnology", "conectivity", "stateId", "locationId", "historial", "_count", "_avg", "_max", "_min", "_sum"],
    ProductScalarWhereWithAggregatesInput: ["AND", "OR", "NOT", "id_product", "internal_code", "serial_number", "imei", "observation", "picture", "model", "product_typeId", "size", "tecnology", "conectivity", "stateId", "locationId", "historial"],
    ...
    ComputerWhereInput: ["AND", "OR", "NOT", "id_computer", "buy_date", "price", "internal_code", "serial_number", "memory", "hard_disk", "processor", "optical_unit", "model", "state", "stateId", "ip", "softwarecomputer", "softwarecomputerId", "location", "locationId", "observation", "historial", "user_domain", "pass_domain", "user_admin", "pass_admin", "user_local", "pass_local", "user_anydesk", "pass_anydesk", "maintenance", "program"],
    ComputerOrderByWithRelationInput: ["id_computer", "buy_date", "price", "internal_code", "serial_number", "memory", "hard_disk", "processor", "optical_unit", "model", "state", "stateId", "ip", "softwarecomputer", "softwarecomputerId", "location", "locationId", "observation", "historial", "user_domain", "pass_domain", "user_admin", "pass_admin", "user_local", "pass_local", "user_anydesk", "pass_anydesk", "maintenance", "program"],
    ComputerWhereUniqueInput: ["id_computer", "internal_code"],
    ComputerOrderByWithAggregationInput: ["id_computer", "buy_date", "price", "internal_code", "serial_number", "memory", "hard_disk", "processor", "optical_unit", "model", "stateId", "ip", "softwarecomputerId", "locationId", "observation", "historial", "user_domain", "pass_domain", "user_admin", "pass_admin", "user_local", "pass_local", "user_anydesk", "pass_anydesk", "_count", "_avg", "_max", "_min", "_sum"],
    ComputerScalarWhereWithAggregatesInput: ["AND", "OR", "NOT", "id_computer", "buy_date", "price", "internal_code", "serial_number", "memory", "hard_disk", "processor", "optical_unit", "model", "stateId", "ip", "softwarecomputerId", "locationId", "observation", "historial", "user_domain", "pass_domain", "user_admin", "pass_admin", "user_local", "pass_local", "user_anydesk", "pass_anydesk"],
    SoftwareComputerWhereInput: ["AND", "OR", "NOT", "id_softwarecomputer", "computer", "operatingsystem", "license_soA", "architecture"],
    SoftwareComputerOrderByWithRelationInput: ["id_softwarecomputer", "computer", "operatingsystem", "license_soA", "architecture"],
    SoftwareComputerWhereUniqueInput: ["id_softwarecomputer"],
    SoftwareComputerOrderByWithAggregationInput: ["id_softwarecomputer", "operatingsystem", "license_soA", "architecture", "_count", "_avg", "_max", "_min", "_sum"],
    SoftwareComputerScalarWhereWithAggregatesInput: ["AND", "OR", "NOT", "id_softwarecomputer", "operatingsystem", "license_soA", "architecture"],
    ProgramWhereInput: ["AND", "OR", "NOT", "id_program", "name_program", "version_program", "license_program", "computer"],
    ProgramOrderByWithRelationInput: ["id_program", "name_program", "version_program", "license_program", "computer"],
    ProgramWhereUniqueInput: ["id_program"],
    ProgramOrderByWithAggregationInput: ["id_program", "name_program", "version_program", "license_program", "_count", "_avg", "_max", "_min", "_sum"],
    ProgramScalarWhereWithAggregatesInput: ["AND", "OR", "NOT", "id_program", "name_program", "version_program", "license_program"],
    LocationWhereInput: ["AND", "OR", "NOT", "id_location", "internal_code", "city", "job_name", "computer", "porduct"],
    LocationOrderByWithRelationInput: ["id_location", "internal_code", "city", "job_name", "computer", "porduct"],
    LocationWhereUniqueInput: ["id_location"],
    LocationOrderByWithAggregationInput: ["id_location", "internal_code", "city", "job_name", "_count", "_avg", "_max", "_min", "_sum"],
    LocationScalarWhereWithAggregatesInput: ["AND", "OR", "NOT", "id_location", "internal_code", "city", "job_name"],
    MaintenanceWhereInput: ["AND", "OR", "NOT", "id_maintenance", "date_maintenance", "jworkerNameFirm", "user", "userId", "computer", "computerId", "product", "observation"],
    MaintenanceOrderByWithRelationInput: ["id_maintenance", "date_maintenance", "jworkerNameFirm", "user", "userId", "computer", "computerId", "product", "observation"],
    MaintenanceWhereUniqueInput: ["id_maintenance"],
    MaintenanceOrderByWithAggregationInput: ["id_maintenance", "date_maintenance", "jworkerNameFirm", "userId", "computerId", "observation", "_count", "_avg", "_max", "_min", "_sum"],
    MaintenanceScalarWhereWithAggregatesInput: ["AND", "OR", "NOT", "id_maintenance", "date_maintenance", "jworkerNameFirm", "userId", "computerId", "observation"],
    ...
    ProductCreateInput: ["internal_code", "serial_number", "imei", "observation", "picture", "model", "product_type", "size", "tecnology", "conectivity", "state", "location", "historial", "maintenance"],
    ProductUpdateInput: ["internal_code", "serial_number", "imei", "observation", "picture", "model", "product_type", "size", "tecnology", "conectivity", "state", "location", "historial", "maintenance"],
    ProductCreateManyInput: ["id_product", "internal_code", "serial_number", "imei", "observation", "picture", "model", "product_typeId", "size", "tecnology", "conectivity", "stateId", "locationId", "historial"],
    ...
    ComputerCreateInput: ["buy_date", "price", "internal_code", "serial_number", "memory", "hard_disk", "processor", "optical_unit", "model", "state", "ip", "softwarecomputer", "location", "observation", "historial", "user_domain", "pass_domain", "user_admin", "pass_admin", "user_local", "pass_local", "user_anydesk", "pass_anydesk", "maintenance", "program"],
    ComputerUpdateInput: ["buy_date", "price", "internal_code", "serial_number", "memory", "hard_disk", "processor", "optical_unit", "model", "state", "ip", "softwarecomputer", "location", "observation", "historial", "user_domain", "pass_domain", "user_admin", "pass_admin", "user_local", "pass_local", "user_anydesk", "pass_anydesk", "maintenance", "program"],
    ComputerCreateManyInput: ["id_computer", "buy_date", "price", "internal_code", "serial_number", "memory", "hard_disk", "processor", "optical_unit", "model", "stateId", "ip", "softwarecomputerId", "locationId", "observation", "historial", "user_domain", "pass_domain", "user_admin", "pass_admin", "user_local", "pass_local", "user_anydesk", "pass_anydesk"],
    ComputerUpdateManyMutationInput: ["buy_date", "price", "internal_code", "serial_number", "memory", "hard_disk", "processor", "optical_unit", "model", "ip", "observation", "historial", "user_domain", "pass_domain", "user_admin", "pass_admin", "user_local", "pass_local", "user_anydesk", "pass_anydesk"],
    SoftwareComputerCreateInput: ["computer", "operatingsystem", "license_soA", "architecture"],
    SoftwareComputerUpdateInput: ["computer", "operatingsystem", "license_soA", "architecture"],
    SoftwareComputerCreateManyInput: ["id_softwarecomputer", "operatingsystem", "license_soA", "architecture"],
    SoftwareComputerUpdateManyMutationInput: ["operatingsystem", "license_soA", "architecture"],
    ProgramCreateInput: ["name_program", "version_program", "license_program", "computer"],
    ProgramUpdateInput: ["name_program", "version_program", "license_program", "computer"],
    ProgramCreateManyInput: ["id_program", "name_program", "version_program", "license_program"],
    ProgramUpdateManyMutationInput: ["name_program", "version_program", "license_program"],
    LocationCreateInput: ["internal_code", "city", "job_name", "computer", "porduct"],
    LocationUpdateInput: ["internal_code", "city", "job_name", "computer", "porduct"],
    LocationCreateManyInput: ["id_location", "internal_code", "city", "job_name"],
    LocationUpdateManyMutationInput: ["internal_code", "city", "job_name"],
    MaintenanceCreateInput: ["date_maintenance", "jworkerNameFirm", "user", "computer", "product", "observation"],
    MaintenanceUpdateInput: ["date_maintenance", "jworkerNameFirm", "user", "computer", "product", "observation"],
    MaintenanceCreateManyInput: ["id_maintenance", "date_maintenance", "jworkerNameFirm", "userId", "computerId", "observation"],
    MaintenanceUpdateManyMutationInput: ["date_maintenance", "jworkerNameFirm", "observation"],
    ...
    ProductCountOrderByAggregateInput: ["id_product", "internal_code", "serial_number", "imei", "observation", "picture", "model", "product_typeId", "size", "tecnology", "conectivity", "stateId", "locationId", "historial"],
    ProductAvgOrderByAggregateInput: ["id_product", "product_typeId", "stateId", "locationId"],
    ProductMaxOrderByAggregateInput: ["id_product", "internal_code", "serial_number", "imei", "observation", "picture", "model", "product_typeId", "size", "tecnology", "conectivity", "stateId", "locationId", "historial"],
    ProductMinOrderByAggregateInput: ["id_product", "internal_code", "serial_number", "imei", "observation", "picture", "model", "product_typeId", "size", "tecnology", "conectivity", "stateId", "locationId", "historial"],
    ProductSumOrderByAggregateInput: ["id_product", "product_typeId", "stateId", "locationId"],
    ...
    ComputerCountOrderByAggregateInput: ["id_computer", "buy_date", "price", "internal_code", "serial_number", "memory", "hard_disk", "processor", "optical_unit", "model", "stateId", "ip", "softwarecomputerId", "locationId", "observation", "historial", "user_domain", "pass_domain", "user_admin", "pass_admin", "user_local", "pass_local", "user_anydesk", "pass_anydesk"],
    ComputerAvgOrderByAggregateInput: ["id_computer", "price", "stateId", "softwarecomputerId", "locationId"],
    ComputerMaxOrderByAggregateInput: ["id_computer", "buy_date", "price", "internal_code", "serial_number", "memory", "hard_disk", "processor", "optical_unit", "model", "stateId", "ip", "softwarecomputerId", "locationId", "observation", "historial", "user_domain", "pass_domain", "user_admin", "pass_admin", "user_local", "pass_local", "user_anydesk", "pass_anydesk"],
    ComputerMinOrderByAggregateInput: ["id_computer", "buy_date", "price", "internal_code", "serial_number", "memory", "hard_disk", "processor", "optical_unit", "model", "stateId", "ip", "softwarecomputerId", "locationId", "observation", "historial", "user_domain", "pass_domain", "user_admin", "pass_admin", "user_local", "pass_local", "user_anydesk", "pass_anydesk"],
    ComputerSumOrderByAggregateInput: ["id_computer", "price", "stateId", "softwarecomputerId", "locationId"],
    ...
    SoftwareComputerCountOrderByAggregateInput: ["id_softwarecomputer", "operatingsystem", "license_soA", "architecture"],
    SoftwareComputerAvgOrderByAggregateInput: ["id_softwarecomputer"],
    SoftwareComputerMaxOrderByAggregateInput: ["id_softwarecomputer", "operatingsystem", "license_soA", "architecture"],
    SoftwareComputerMinOrderByAggregateInput: ["id_softwarecomputer", "operatingsystem", "license_soA", "architecture"],
    ...
    ProgramCountOrderByAggregateInput: ["id_program", "name_program", "version_program", "license_program"],
    ProgramAvgOrderByAggregateInput: ["id_program"],
    ProgramMaxOrderByAggregateInput: ["id_program", "name_program", "version_program", "license_program"],
    ProgramMinOrderByAggregateInput: ["id_program", "name_program", "version_program", "license_program"],
    ProgramSumOrderByAggregateInput: ["id_program"],
    LocationCountOrderByAggregateInput: ["id_location", "internal_code", "city", "job_name"],
    LocationAvgOrderByAggregateInput: ["id_location", "internal_code"],
    LocationMaxOrderByAggregateInput: ["id_location", "internal_code", "city", "job_name"],
    LocationMinOrderByAggregateInput: ["id_location", "internal_code", "city", "job_name"],
    LocationSumOrderByAggregateInput: ["id_location", "internal_code"],
    UserRelationFilter: ["is", "isNot"],
    ComputerRelationFilter: ["is", "isNot"],
    MaintenanceCountOrderByAggregateInput: ["id_maintenance", "date_maintenance", "jworkerNameFirm", "userId", "computerId", "observation"],
    MaintenanceAvgOrderByAggregateInput: ["id_maintenance", "computerId"],
    MaintenanceMaxOrderByAggregateInput: ["id_maintenance", "date_maintenance", "jworkerNameFirm", "userId", "computerId", "observation"],
    MaintenanceMinOrderByAggregateInput: ["id_maintenance", "date_maintenance", "jworkerNameFirm", "userId", "computerId", "observation"],
    MaintenanceSumOrderByAggregateInput: ["id_maintenance", "computerId"],
    ...
    LocationCreateNestedOneWithoutPorductInput: ["create", "connectOrCreate", "connect"],
    MaintenanceCreateNestedManyWithoutProductInput: ["create", "connectOrCreate", "connect"],
    ...
    LocationUpdateOneRequiredWithoutPorductInput: ["create", "connectOrCreate", "upsert", "connect", "update"],
    MaintenanceUpdateManyWithoutProductInput: ["create", "connectOrCreate", "upsert", "set", "disconnect", "delete", "connect", "update", "updateMany", "deleteMany"],
    ...
    LocationCreateNestedOneWithoutComputerInput: ["create", "connectOrCreate", "connect"],
    MaintenanceCreateNestedManyWithoutComputerInput: ["create", "connectOrCreate", "createMany", "connect"],
    ProgramCreateNestedManyWithoutComputerInput: ["create", "connectOrCreate", "connect"],
    ...
    LocationUpdateOneRequiredWithoutComputerInput: ["create", "connectOrCreate", "upsert", "connect", "update"],
    MaintenanceUpdateManyWithoutComputerInput: ["create", "connectOrCreate", "upsert", "createMany", "set", "disconnect", "delete", "connect", "update", "updateMany", "deleteMany"],
    ProgramUpdateManyWithoutComputerInput: ["create", "connectOrCreate", "upsert", "set", "disconnect", "delete", "connect", "update", "updateMany", "deleteMany"],
    ...
    ComputerCreateNestedManyWithoutProgramInput: ["create", "connectOrCreate", "connect"],
    ComputerUpdateManyWithoutProgramInput: ["create", "connectOrCreate", "upsert", "set", "disconnect", "delete", "connect", "update", "updateMany", "deleteMany"],
    ComputerCreateNestedManyWithoutLocationInput: ["create", "connectOrCreate", "createMany", "connect"],
    ProductCreateNestedManyWithoutLocationInput: ["create", "connectOrCreate", "createMany", "connect"],
    ComputerUpdateManyWithoutLocationInput: ["create", "connectOrCreate", "upsert", "createMany", "set", "disconnect", "delete", "connect", "update", "updateMany", "deleteMany"],
    ProductUpdateManyWithoutLocationInput: ["create", "connectOrCreate", "upsert", "createMany", "set", "disconnect", "delete", "connect", "update", "updateMany", "deleteMany"],
    UserCreateNestedOneWithoutMantenanceInput: ["create", "connectOrCreate", "connect"],
    ComputerCreateNestedOneWithoutMaintenanceInput: ["create", "connectOrCreate", "connect"],
    ProductCreateNestedManyWithoutMaintenanceInput: ["create", "connectOrCreate", "connect"],
    UserUpdateOneRequiredWithoutMantenanceInput: ["create", "connectOrCreate", "upsert", "connect", "update"],
    ComputerUpdateOneRequiredWithoutMaintenanceInput: ["create", "connectOrCreate", "upsert", "connect", "update"],
    ProductUpdateManyWithoutMaintenanceInput: ["create", "connectOrCreate", "upsert", "set", "disconnect", "delete", "connect", "update", "updateMany", "deleteMany"],
    ...
    LocationCreateWithoutPorductInput: ["internal_code", "city", "job_name", "computer"],
    LocationCreateOrConnectWithoutPorductInput: ["where", "create"],
    MaintenanceCreateWithoutProductInput: ["date_maintenance", "jworkerNameFirm", "user", "computer", "observation"],
    MaintenanceCreateOrConnectWithoutProductInput: ["where", "create"],
    ...
    LocationUpsertWithoutPorductInput: ["update", "create"],
    LocationUpdateWithoutPorductInput: ["internal_code", "city", "job_name", "computer"],
    MaintenanceUpsertWithWhereUniqueWithoutProductInput: ["where", "update", "create"],
    MaintenanceUpdateWithWhereUniqueWithoutProductInput: ["where", "data"],
    MaintenanceUpdateManyWithWhereWithoutProductInput: ["where", "data"],
    MaintenanceScalarWhereInput: ["AND", "OR", "NOT", "id_maintenance", "date_maintenance", "jworkerNameFirm", "userId", "computerId", "observation"],
    ProductCreateWithoutProduct_typeInput: ["internal_code", "serial_number", "imei", "observation", "picture", "model", "size", "tecnology", "conectivity", "state", "location", "historial", "maintenance"],
    ...
    ProductScalarWhereInput: ["AND", "OR", "NOT", "id_product", "internal_code", "serial_number", "imei", "observation", "picture", "model", "product_typeId", "size", "tecnology", "conectivity", "stateId", "locationId", "historial"],
    ProductCreateWithoutStateInput: ["internal_code", "serial_number", "imei", "observation", "picture", "model", "product_type", "size", "tecnology", "conectivity", "location", "historial", "maintenance"],
    ProductCreateOrConnectWithoutStateInput: ["where", "create"],
    ProductCreateManyStateInputEnvelope: ["data", "skipDuplicates"],
    ComputerCreateWithoutStateInput: ["buy_date", "price", "internal_code", "serial_number", "memory", "hard_disk", "processor", "optical_unit", "model", "ip", "softwarecomputer", "location", "observation", "historial", "user_domain", "pass_domain", "user_admin", "pass_admin", "user_local", "pass_local", "user_anydesk", "pass_anydesk", "maintenance", "program"],
    ...
    ComputerScalarWhereInput: ["AND", "OR", "NOT", "id_computer", "buy_date", "price", "internal_code", "serial_number", "memory", "hard_disk", "processor", "optical_unit", "model", "stateId", "ip", "softwarecomputerId", "locationId", "observation", "historial", "user_domain", "pass_domain", "user_admin", "pass_admin", "user_local", "pass_local", "user_anydesk", "pass_anydesk"],
    StateCreateWithoutComputerInput: ["description", "product"],
    StateCreateOrConnectWithoutComputerInput: ["where", "create"],
    SoftwareComputerCreateWithoutComputerInput: ["operatingsystem", "license_soA", "architecture"],
    SoftwareComputerCreateOrConnectWithoutComputerInput: ["where", "create"],
    LocationCreateWithoutComputerInput: ["internal_code", "city", "job_name", "porduct"],
    LocationCreateOrConnectWithoutComputerInput: ["where", "create"],
    MaintenanceCreateWithoutComputerInput: ["date_maintenance", "jworkerNameFirm", "user", "product", "observation"],
    MaintenanceCreateOrConnectWithoutComputerInput: ["where", "create"],
    MaintenanceCreateManyComputerInputEnvelope: ["data", "skipDuplicates"],
    ProgramCreateWithoutComputerInput: ["name_program", "version_program", "license_program"],
    ProgramCreateOrConnectWithoutComputerInput: ["where", "create"],
    ...
    SoftwareComputerUpdateWithoutComputerInput: ["operatingsystem", "license_soA", "architecture"],
    LocationUpsertWithoutComputerInput: ["update", "create"],
    LocationUpdateWithoutComputerInput: ["internal_code", "city", "job_name", "porduct"],
    MaintenanceUpsertWithWhereUniqueWithoutComputerInput: ["where", "update", "create"],
    MaintenanceUpdateWithWhereUniqueWithoutComputerInput: ["where", "data"],
    MaintenanceUpdateManyWithWhereWithoutComputerInput: ["where", "data"],
    ProgramUpsertWithWhereUniqueWithoutComputerInput: ["where", "update", "create"],
    ProgramUpdateWithWhereUniqueWithoutComputerInput: ["where", "data"],
    ProgramUpdateManyWithWhereWithoutComputerInput: ["where", "data"],
    ProgramScalarWhereInput: ["AND", "OR", "NOT", "id_program", "name_program", "version_program", "license_program"],
    ComputerCreateWithoutSoftwarecomputerInput: ["buy_date", "price", "internal_code", "serial_number", "memory", "hard_disk", "processor", "optical_unit", "model", "state", "ip", "location", "observation", "historial", "user_domain", "pass_domain", "user_admin", "pass_admin", "user_local", "pass_local", "user_anydesk", "pass_anydesk", "maintenance", "program"],
    ...
    ComputerCreateWithoutProgramInput: ["buy_date", "price", "internal_code", "serial_number", "memory", "hard_disk", "processor", "optical_unit", "model", "state", "ip", "softwarecomputer", "location", "observation", "historial", "user_domain", "pass_domain", "user_admin", "pass_admin", "user_local", "pass_local", "user_anydesk", "pass_anydesk", "maintenance"],
    ComputerCreateOrConnectWithoutProgramInput: ["where", "create"],
    ComputerUpsertWithWhereUniqueWithoutProgramInput: ["where", "update", "create"],
    ComputerUpdateWithWhereUniqueWithoutProgramInput: ["where", "data"],
    ComputerUpdateManyWithWhereWithoutProgramInput: ["where", "data"],
    ComputerCreateWithoutLocationInput: ["buy_date", "price", "internal_code", "serial_number", "memory", "hard_disk", "processor", "optical_unit", "model", "state", "ip", "softwarecomputer", "observation", "historial", "user_domain", "pass_domain", "user_admin", "pass_admin", "user_local", "pass_local", "user_anydesk", "pass_anydesk", "maintenance", "program"],
    ComputerCreateOrConnectWithoutLocationInput: ["where", "create"],
    ComputerCreateManyLocationInputEnvelope: ["data", "skipDuplicates"],
    ProductCreateWithoutLocationInput: ["internal_code", "serial_number", "imei", "observation", "picture", "model", "product_type", "size", "tecnology", "conectivity", "state", "historial", "maintenance"],
    ProductCreateOrConnectWithoutLocationInput: ["where", "create"],
    ProductCreateManyLocationInputEnvelope: ["data", "skipDuplicates"],
    ComputerUpsertWithWhereUniqueWithoutLocationInput: ["where", "update", "create"],
    ComputerUpdateWithWhereUniqueWithoutLocationInput: ["where", "data"],
    ComputerUpdateManyWithWhereWithoutLocationInput: ["where", "data"],
    ProductUpsertWithWhereUniqueWithoutLocationInput: ["where", "update", "create"],
    ProductUpdateWithWhereUniqueWithoutLocationInput: ["where", "data"],
    ProductUpdateManyWithWhereWithoutLocationInput: ["where", "data"],
    ...
    ComputerCreateWithoutMaintenanceInput: ["buy_date", "price", "internal_code", "serial_number", "memory", "hard_disk", "processor", "optical_unit", "model", "state", "ip", "softwarecomputer", "location", "observation", "historial", "user_domain", "pass_domain", "user_admin", "pass_admin", "user_local", "pass_local", "user_anydesk", "pass_anydesk", "program"],
    ComputerCreateOrConnectWithoutMaintenanceInput: ["where", "create"],
    ProductCreateWithoutMaintenanceInput: ["internal_code", "serial_number", "imei", "observation", "picture", "model", "product_type", "size", "tecnology", "conectivity", "state", "location", "historial"],
    ProductCreateOrConnectWithoutMaintenanceInput: ["where", "create"],
    ...
    ComputerUpsertWithoutMaintenanceInput: ["update", "create"],
    ComputerUpdateWithoutMaintenanceInput: ["buy_date", "price", "internal_code", "serial_number", "memory", "hard_disk", "processor", "optical_unit", "model", "state", "ip", "softwarecomputer", "location", "observation", "historial", "user_domain", "pass_domain", "user_admin", "pass_admin", "user_local", "pass_local", "user_anydesk", "pass_anydesk", "program"],
    ProductUpsertWithWhereUniqueWithoutMaintenanceInput: ["where", "update", "create"],
    ProductUpdateWithWhereUniqueWithoutMaintenanceInput: ["where", "data"],
    ProductUpdateManyWithWhereWithoutMaintenanceInput: ["where", "data"],
    ...
    MaintenanceCreateWithoutUserInput: ["date_maintenance", "jworkerNameFirm", "computer", "product", "observation"],
    ...
    MaintenanceUpdateWithoutProductInput: ["date_maintenance", "jworkerNameFirm", "user", "computer", "observation"],
    ProductCreateManyProduct_typeInput: ["id_product", "internal_code", "serial_number", "imei", "observation", "picture", "model", "size", "tecnology", "conectivity", "stateId", "locationId", "historial"],
    ProductUpdateWithoutProduct_typeInput: ["internal_code", "serial_number", "imei", "observation", "picture", "model", "size", "tecnology", "conectivity", "state", "location", "historial", "maintenance"],
    ProductCreateManyStateInput: ["id_product", "internal_code", "serial_number", "imei", "observation", "picture", "model", "product_typeId", "size", "tecnology", "conectivity", "locationId", "historial"],
    ComputerCreateManyStateInput: ["id_computer", "buy_date", "price", "internal_code", "serial_number", "memory", "hard_disk", "processor", "optical_unit", "model", "ip", "softwarecomputerId", "locationId", "observation", "historial", "user_domain", "pass_domain", "user_admin", "pass_admin", "user_local", "pass_local", "user_anydesk", "pass_anydesk"],
    ProductUpdateWithoutStateInput: ["internal_code", "serial_number", "imei", "observation", "picture", "model", "product_type", "size", "tecnology", "conectivity", "location", "historial", "maintenance"],
    ComputerUpdateWithoutStateInput: ["buy_date", "price", "internal_code", "serial_number", "memory", "hard_disk", "processor", "optical_unit", "model", "ip", "softwarecomputer", "location", "observation", "historial", "user_domain", "pass_domain", "user_admin", "pass_admin", "user_local", "pass_local", "user_anydesk", "pass_anydesk", "maintenance", "program"],
    MaintenanceCreateManyComputerInput: ["id_maintenance", "date_maintenance", "jworkerNameFirm", "userId", "observation"],
    MaintenanceUpdateWithoutComputerInput: ["date_maintenance", "jworkerNameFirm", "user", "product", "observation"],
    ProgramUpdateWithoutComputerInput: ["name_program", "version_program", "license_program"],
    ComputerCreateManySoftwarecomputerInput: ["id_computer", "buy_date", "price", "internal_code", "serial_number", "memory", "hard_disk", "processor", "optical_unit", "model", "stateId", "ip", "locationId", "observation", "historial", "user_domain", "pass_domain", "user_admin", "pass_admin", "user_local", "pass_local", "user_anydesk", "pass_anydesk"],
    ComputerUpdateWithoutSoftwarecomputerInput: ["buy_date", "price", "internal_code", "serial_number", "memory", "hard_disk", "processor", "optical_unit", "model", "state", "ip", "location", "observation", "historial", "user_domain", "pass_domain", "user_admin", "pass_admin", "user_local", "pass_local", "user_anydesk", "pass_anydesk", "maintenance", "program"],
    ComputerUpdateWithoutProgramInput: ["buy_date", "price", "internal_code", "serial_number", "memory", "hard_disk", "processor", "optical_unit", "model", "state", "ip", "softwarecomputer", "location", "observation", "historial", "user_domain", "pass_domain", "user_admin", "pass_admin", "user_local", "pass_local", "user_anydesk", "pass_anydesk", "maintenance"],
    ComputerCreateManyLocationInput: ["id_computer", "buy_date", "price", "internal_code", "serial_number", "memory", "hard_disk", "processor", "optical_unit", "model", "stateId", "ip", "softwarecomputerId", "observation", "historial", "user_domain", "pass_domain", "user_admin", "pass_admin", "user_local", "pass_local", "user_anydesk", "pass_anydesk"],
    ProductCreateManyLocationInput: ["id_product", "internal_code", "serial_number", "imei", "observation", "picture", "model", "product_typeId", "size", "tecnology", "conectivity", "stateId", "historial"],
    ComputerUpdateWithoutLocationInput: ["buy_date", "price", "internal_code", "serial_number", "memory", "hard_disk", "processor", "optical_unit", "model", "state", "ip", "softwarecomputer", "observation", "historial", "user_domain", "pass_domain", "user_admin", "pass_admin", "user_local", "pass_local", "user_anydesk", "pass_anydesk", "maintenance", "program"],
    ProductUpdateWithoutLocationInput: ["internal_code", "serial_number", "imei", "observation", "picture", "model", "product_type", "size", "tecnology", "conectivity", "state", "historial", "maintenance"],
    ProductUpdateWithoutMaintenanceInput: ["internal_code", "serial_number", "imei", "observation", "picture", "model", "product_type", "size", "tecnology", "conectivity", "state", "location", "historial"],
    ...
    MaintenanceCreateManyUserInput: ["id_maintenance", "date_maintenance", "jworkerNameFirm", "computerId", "observation"],
    ...
    MaintenanceUpdateWithoutUserInput: ["date_maintenance", "jworkerNameFirm", "computer", "product", "observation"]
};
